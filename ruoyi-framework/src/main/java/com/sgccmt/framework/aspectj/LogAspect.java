package com.sgccmt.framework.aspectj;
...
import com.sgccmt.common.enums.BusinessStatus;
import com.sgccmt.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.sgccmt.common.annotation.Log)")
